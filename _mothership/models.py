...
class LocalLLMStatus:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            'models': [m.to_card_dict() if hasattr(m, 'to_card_dict') else m.to_dict() for m in self.models],
            'duplicate_groups': {
                k: [m.to_card_dict() if hasattr(m, 'to_card_dict') else m.to_dict() for m in v]
