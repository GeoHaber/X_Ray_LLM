...
def test_Analysis_auto_rustify_PipelineReport_has_methods():
    """Verify PipelineReport has expected methods."""
    from Analysis.auto_rustify import PipelineReport
    expected = ["to_dict"]
    for method in expected:
        assert hasattr(PipelineReport, method), f"Missing method: {method}"
