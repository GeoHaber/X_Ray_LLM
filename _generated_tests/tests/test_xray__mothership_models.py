...
def test__mothership_models_to_list_return_type():
    """Verify to_list returns expected type."""
    from _mothership.models import to_list
...
def test__mothership_models_tier_return_type():
...
def test__mothership_models_tier_label_return_type():
...
def test__mothership_models_recommended_gpu_layers_return_type():
...
def test__mothership_models_fingerprint_return_type():
...
def test__mothership_models_to_dict_return_type():
...
def test__mothership_models_to_card_dict_return_type():
    """Verify to_card_dict returns expected type."""
    from _mothership.models import to_card_dict
    # Smoke check — return type should be: dict
    # (requires valid args to test; assert function exists)
    assert callable(to_card_dict)
