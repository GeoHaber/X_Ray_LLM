...
def test_Analysis_ast_utils_visit_FunctionDef_none_args():
    """Monkey: call visit_FunctionDef with None args — should not crash unhandled."""
    from Analysis.ast_utils import visit_FunctionDef
...
def test_Analysis_ast_utils_visit_Name_none_args():
...
def test_Analysis_ast_utils_visit_arg_none_args():
    """Monkey: call visit_arg with None args — should not crash unhandled."""
    from Analysis.ast_utils import visit_arg
...
def test_Analysis_ast_utils_ASTNormalizer_inheritance():
    """Verify ASTNormalizer inherits from expected bases."""
    from Analysis.ast_utils import ASTNormalizer

    base_names = [b.__name__ for b in ASTNormalizer.__mro__]
    for base in ["ast.NodeTransformer"]:
