...
sys.path.insert(0, ".")
from x_ray_claude import scan_codebase, DuplicateFinder, _HAS_RUST
...
print(
    f"Scanned: {len(functions)} functions in {len(set(f.file_path for f in functions))} files ({scan_time:.2f}s)"
)
